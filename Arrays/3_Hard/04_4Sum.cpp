...
// Note-
// 1)Time Complexity: O(N3*log(M)), where N = size of the array, M = no. of elements in the set.
...
// Note-
// 1)Time Complexity: O(N3), where N = size of the array.
