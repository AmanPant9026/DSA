...
// int main()
// {
//     vector<int> a={1,1,2,5,6};
//     vector<int> ans = findMissingRepeatingNumber(a);
//     cout << "The repeatng and missing number are: {"
//          << ans[0]<<","<<ans[1] << "}\n";
//     return 0;
// }

// Note-
// 1)Time Complexity: O(2N), where N = the size of the given array.
// Reason: We are using two loops each running for N times. So, the time complexity will be O(2N).
// 2)Space Complexity: O(N) as we are using a hash array to solve this problem.
